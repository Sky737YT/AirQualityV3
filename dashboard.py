...
try:
    ...
    STATIONS = [
        ...
        # Southeast & Mid-South
        ("KATL", 33.640, -84.427), ("KBHM", 33.562, -86.753), ("KBNA", 36.126, -86.677),
        ("KMEM", 35.042, -89.978), ("KCLT", 35.214, -80.943), ("KRDU", 35.877, -78.787),
        ("KCHS", 32.898, -80.040), ("KSAV", 32.127, -81.202), ("KMCO", 28.429, -81.309),
        ("KTPA", 27.977, -82.534), ("KFLL", 26.072, -80.153), ("KMIA", 25.796, -80.291),

        # Midwest
        ("KORD", 41.978, -87.904), ("KMDW", 41.786, -87.752), ("KIND", 39.717, -86.294),
        ("KSTL", 38.748, -90.37), ("KMCI", 39.297, -94.713), ("KMSP", 44.883, -93.222),
        ("KMKE", 42.948, -87.897), ("KDSM", 41.534, -93.663), ("KOMA", 41.303, -95.894)
    ]
